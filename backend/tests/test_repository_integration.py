...
def proposal() -> PipelineProposal:
    return PipelineProposal(
        proposal_id=str(uuid4()), version=1, status="draft", runtime="nifi",
        ...
        assumptions=[], risks=[], confidence=90, explanation="test", requirement="Ingest customers hourly.",
    )
